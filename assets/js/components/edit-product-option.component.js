  ...
  <div class="my-3 p-3 p-md-4 rounded action-card">
    <details>
      ...
      <div class="action-card__content">
        <ajax-form :form-data="productOption" :form-rules="formRules" :syncing.sync="syncing" :form-errors.sync="formErrors" @submitted="createdProductOption" :action="(productOption.id) ?  'editProductOption' : 'createProductOption'">
