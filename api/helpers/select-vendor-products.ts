...
with products as (
  ...
  FROM "vendor" vendor
	left join "product" product on "vendor"."id" = "product"."vendor"
	left join "productoption" productoption on "product"."id" = "productoption"."product" 
	left join "productoptionvalue" productoptionvalue on "productoptionvalue"."option" = "productoption"."id" 
	left join "productcategory" productcategory on "productcategory"."id" = "product"."category" 
	left join "categorygroup" categorygroup on "categorygroup"."id" = "productcategory"."categoryGroup"
)
, esc as (
	select
		products.*,
