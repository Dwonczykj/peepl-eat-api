...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  'POST /api/v1/admin/customer-cancel-order': { action: 'admin/customer-cancel-order' },
  'POST /api/v1/admin/customer-update-paid-order': { action: 'admin/customer-update-paid-order' },
  'POST /api/v1/admin/customer-received-order': { action: 'admin/customer-received-order' },
