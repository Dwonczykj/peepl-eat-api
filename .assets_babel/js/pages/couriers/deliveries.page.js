...
parasails.registerPage('deliveries', {
  ...
  //  ╩╝╚╝ ╩ ╚═╝╩╚═╩ ╩╚═╝ ╩ ╩╚═╝╝╚╝╚═╝
  methods: {
    clickAcceptDelivery: function clickAcceptDelivery(orderId) {
      var _this = this;
      ...
      .then(function () {
        _this.order.courierAccepted = true; // Here we can access state variables on the page without loading the data from the db again!

        _this.order.deliveryId = _this.deliveryIdsMap[orderId];
        window.location.reload();
      });
    },
    changeCourierDeliveryId: function changeCourierDeliveryId(orderId, newDeliveryId) {
