...
const DEFAULT_NEW_DISCOUNTCODE_OBJECT = (fixtures, overrides = {}) => {
...
class ExpectResponseDiscountCode extends ExpectResponse {
  constructor({
    HTTP_TYPE = 'get',
    ACTION_PATH = '',
    ACTION_NAME = '',
...
class HttpAuthTestSenderDiscountCode extends HttpAuthTestSender {
  constructor({
    HTTP_TYPE = 'get',
    ...
    super({
      ...
      sendData,
      expectResponse,
      ExpectResponseDiscountCode: ExpectResponseDiscountCode,
      expectResponseCb,
      expectStatusCode,
    });
  }
...
module.exports = {
  DEFAULT_NEW_DISCOUNTCODE_OBJECT: DEFAULT_NEW_DISCOUNTCODE_OBJECT,
  ExpectResponseDiscountCode: ExpectResponseDiscountCode,
  HttpAuthTestSenderDiscountCode: HttpAuthTestSenderDiscountCode,
};
